<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <div>
            ...
            <x-text-input id="learning_style" class="block mt-1 w-full" type="text" name="learning_style" />
        ...
        <div>
            ...
            <x-text-input id="skill" class="block mt-1 w-full" type="text" name="skill" />
